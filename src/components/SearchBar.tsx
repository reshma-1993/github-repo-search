...
export const SearchBar = (props: Props) => {
  ...
  const handleKeyPress = (e: Event) => {
    if (e.key === "Enter" || e.currentTarget.title === "search") {
      text ? handleSubmit() : alert("Please enter search term to get results");
    }
  };
  ...
  return (
    <form>
      <StyledInput className={"inputWithIcon"}>
        ...
        <button aria-label="Clear search field" className="right-icon" onClick={clearInput}>
          <svg width="24pt" height="24pt" viewBox="0 0 34 24" version="1.1">
            <g id="surface1">
